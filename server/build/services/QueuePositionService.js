...
const updateQueuePositionService = async (doctorId, date) => {
    const lastPosition = await Appointment.max('queuePosition', {
        where: {
            doctorId,
            date,
            status: {
...
export const resequenceQueuePositions = async (doctorId, date) => {
...
//# sourceMappingURL=QueuePositionService.js.map