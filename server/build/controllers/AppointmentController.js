...
class AppointmentController {
    static async bookAppointMent(req, res) {
        ...
        const generatedSlots = generateTimeSlots(availability.startTime, availability.endTime, avg, availability.breakStart, availability.breakEnd);
    ...
    static async getMyAppointmentDetails(req, res) {
    ...
    static async cancelMyAppointment(req, res) {
        ...
        const appointmentWithPatient = appointment;
